function verificaBodyPostProdutos(body) {
    ...
    if(body.estoque == undefined) {throw new Error("Estoque: não digitado")};
    ...
    if(body.urlImagem == undefined) {throw new Error("Url da imagem: não digitada")};
    if(typeof(body.descricao) !== "string") {throw new Error("Url: precisa ser uma String")};
};
